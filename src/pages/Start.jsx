...
const Start = () => {
  return (
    <div>
      <div className='bg-cover bg-center bg-[url(https://res.cloudinary.com/dmq0zgt1x/image/upload/v1747645801/image_eqnrev.png)] h-screen pt-8 flex justify-between flex-col w-full'>
        ...
        <div className='bg-white pb-8 py-4 px-4'>
          <h2 className='text-[30px] font-semibold'>Get Started with GoRide</h2>
